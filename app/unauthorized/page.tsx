  ...
  return (
    <div className="min-h-screen bg-[#1A0A00] flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-[#722F37] hover:bg-[#8b353f] text-white font-medium px-6 py-3 rounded-lg transition-colors border border-[#D4AF37]/20 shadow-md shadow-[#722F37]/20"
        >
          Return to Dashboard
        </Link>
      </div>
